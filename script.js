...
// [{ দুই শব্দের মাঝে একটিমাত্র স্পেস দিতে পারবেন
//   একাধিক স্পেস দিলে স্বয়ংক্রিয়ভাবে কমে যাবে
//   বাংলা অক্ষর + নির্দিষ্ট চিহ্ন লিখা যাবে
//   বাংলা সংখ্যা বা ইংরেজি সংখ্যা লেখা যাবে না }
//   bangla_only.js

document.addEventListener("DOMContentLoaded", function () {
    const inputs = document.querySelectorAll(".bangla_only");
    ...
    inputs.forEach(input => {
      input.addEventListener("input", function () {
        ...
        for (let i = 0; i < this.value.length; i++) {
          ...
          // বাংলা সংখ্যা ০-৯ বাদ (09E6–09EF)
          const isBanglaDigit = cp >= 0x09E6 && cp <= 0x09EF;
  
          // অনুমোদিত বাংলা অক্ষর (0980–09FF), চিহ্ন
          const allowed = /[ঀ-৿ঃ:()\/'"“”\-]/;
          ...
          } else if (!isBanglaDigit && allowed.test(ch)) {
            result += ch;
            lastWasSpace = false;
          }
        }
...
//   একাধিক স্পেস দিলে স্বয়ংক্রিয়ভাবে কমে যাবে
//   বাংলা অক্ষর + নির্দিষ্ট চিহ্ন লিখা যাবে
//   বাংলা সংখ্যা বা ইংরেজি সংখ্যা লেখা যাবে }
//   bangla_only.js

document.addEventListener("DOMContentLoaded", function() {
    const inputs = document.querySelectorAll(".bangla_with_number");
          
        // সব ধরনের ড্যাশ / হাইফেন / মাইনাস ইউনিকোড
             const dashUnicode = [
              '\u002D','\u00AD','\u058A','\u05BE','\u1400','\u1806',
              '\u2010','\u2011','\u2012','\u2013','\u2014','\u2015',
              '\u207B','\u208B','\u2212','\u2E3A','\u2E3B','\uFE58',
            ...
            function normalizeDash(str) {
              dashUnicode.forEach(d => { str = str.split(d).join('-'); });
              return str;
            }
           ...
           inputs.forEach(input => {
              input.addEventListener("input", function() {
                ...
                const engToBanDigits = {'0':'০','1':'১','2':'২','3':'৩','4':'৪','5':'৫','6':'৬','7':'৭','8':'৮','9':'৯'};
                text = text.replace(/[0-9]/g, d => engToBanDigits[d]);
          
                // সব ড্যাশ → "-"
                text = normalizeDash(text);
          
                // অনুমোদিত ক্যারেক্টার: বাংলা অক্ষর, সংখ্যা, স্পেস, অনুমোদিত চিহ্ন, যেকোনো জায়গায় "-"
                text = text.replace(/[^ঀ-৾০-৯ঃ:()\-/'"“”, ]/g, '');
          
                // একাধিক স্পেস → একটিতে নামানো
